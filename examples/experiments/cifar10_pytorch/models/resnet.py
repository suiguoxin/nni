...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, channel_size=64, kernel_size=3, pooling_size=4, num_classes=10):
...
def ResNet18(channel_size=64, kernel_size=3, pooling_size=4):
